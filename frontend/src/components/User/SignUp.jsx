...
function SignUp() {
  ...
  const { loading, successotp, error, success } = useSelector(
    (state) => state.auth
  );
    ...
    <>
      ...
      >
        ...
        >
            ...
            <div className="flex gap-4">
              {["password", "confirmPassword"].map((field, index) => (
                <label key={field} className="relative w-1/2">
                  ...
                  >
                    {index === 0 ? "Create Password" : "Confirm Password"}{" "}
                    <sup className="text-red-500">*</sup>
                  </p>
                  <input
                    required
          ...
          <Link
            className="flex justify-end mt-2 text-cyan-500 hover:text-cyan-700"
            to="/login"
          >
